  ...
  return (
    <Container>
      ...
      {mode === "create" && (
        <div>
          <p>
            Room ID: <strong>{generatedRoomID}</strong> (copy this to share with
            your opponent)
          </p>
          <Input
            type="text"
          ...
          />
          <div>
            <Button onClick={() => handleSelectRole("X")}>Play as X</Button>
            <Button onClick={() => handleSelectRole("O")}>Play as O</Button>
          </div>
        </div>
      )}
      {mode === "join" && (
